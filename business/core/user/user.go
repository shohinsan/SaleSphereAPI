...
type Storer interface {
	...
	Query(ctx context.Context, filter QueryFilter, orderBy, pageNumber int, rowsPerPage int) ([]User, error)
...
func (c *Core) Query(ctx context.Context, filter QueryFilter, orderBy, pageNumber int, rowsPerPage int) ([]User, error) {
